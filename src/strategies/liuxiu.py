...
评分体系（满分100分，与凤雏评分可比）：
  ...
  2. VCP 波动收缩形态（20分）— 识别收敛蓄力结构
  3. 板块与市场环境（20分）— 板块强度排名
  4. Serenity 紫苏叶五因子（20分）— 确定需求/受限供给/低关注度/价值捕获/催化剂

来源：
  - Serenity 紫苏叶五因子模型（原创方法论）
  - SEPA 过滤法完整规则手册.md（马克·米勒维尼）
  - A股市场特色分析指南.md（国内适用性调整）
  - 股票池分层管理规则 v1.0 算法B
